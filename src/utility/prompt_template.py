...
4. Use Python to create a detailed write up about the trip itinerary, including the places to visit, the order of visit, preferred transportation option, the detailed description of the places and why they were chosen. Save the file as `trip_itinerary.md`.
